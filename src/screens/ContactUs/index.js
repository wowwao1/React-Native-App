...
class ContactUs extends Component {
  ...
  handleContactUs = () => {
    ...
    showToastMessage("Thank you! Your message has been successfully sent.")
  ...
  validateConatctUs = () => {
    ...
    const subject_text = checkField(this.state.subject);
    const message_text = checkField(this.state.message);
