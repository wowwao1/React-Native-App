...
export const CountryPicker = (props) => {
    ...
    useEffect(() => {
        getCountriesAsync(withEmoji ? FlagType.EMOJI : FlagType.FLAT, translation, region, subregion, countryCodes)
            .then(setCountries)
            .catch(console.error);
