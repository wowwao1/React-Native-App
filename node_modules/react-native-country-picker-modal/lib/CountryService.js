...
const imageJsonUrl = 'https://www.dropbox.com/s/raw/33tmsr0h3eggjke/countries-image.json';
const localData = {
...
const isIncluded = (countryCodes) => (country) => countryCodes && countryCodes.length > 0
    ...
    : true;
export const getCountriesAsync = async (flagType, translation = 'common', region, subregion, countryCodes) => {
